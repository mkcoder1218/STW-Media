  ...
  return (
    <div className="relative text-on-surface bg-dark-bg min-h-screen pt-32 pb-24 px-6 overflow-hidden">
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        ...
        <AnimatePresence mode="wait">
          {showSuccess ? (
            ...
            >
              ...
              {/* Form errors */}
              {errorText && (
                <div className="p-4 bg-red-950/40 border border-red-500/30 text-red-200 rounded-xl text-sm font-semibold">
                  {errorText}
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input 
                    ...
                    required
                    className="w-full bg-[#161818] border border-glass-border rounded-xl px-4 py-3.5 text-white placeholder-on-surface-variant/40 focus:border-vibrant-blue focus:outline-none transition-colors"
                  />
                </div>
              ...
              {/* Row 2: Brand Name and YouTube url */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#161818] border border-glass-border rounded-xl pl-12 pr-4 py-3.5 text-white placeholder-on-surface-variant/40 focus:border-vibrant-blue focus:outline-none transition-colors"
                    />
                  </div>
                </div>
              </div>

              {/* Row 3: Dropdowns for Views and Budget */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <select 
                      ...
                      onChange={handleInputChange}
                      className="w-full bg-[#161818] border border-glass-border rounded-xl px-4 py-3.5 text-white appearance-none focus:border-vibrant-blue focus:outline-none transition-colors"
                    >
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  ...
                  className="w-full bg-[#161818] border border-glass-border rounded-xl px-4 py-3.5 text-white placeholder-on-surface-variant/40 focus:border-vibrant-blue focus:outline-none transition-colors resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 bg-brand-blue hover:bg-vibrant-blue text-white font-bold tracking-wider rounded-xl transition-all cursor-pointer shadow-lg shadow-brand-blue/20 flex items-center justify-center gap-2 active:scale-[0.98] disabled:opacity-50"
              >
                {isSubmitting ? (
                  <>
        ...
        {/* Local Inbox Log for Testing (Delightful Client Interaction feedback) */}
                  ...
                  {sub.servicesInterested.length > 0 && (
                    <div className="flex flex-wrap gap-1.5">
                      {sub.servicesInterested.map((svc) => (
                        <span key={svc} className="text-[10px] bg-brand-blue/10 border border-brand-blue/30 text-vibrant-blue font-bold px-2 py-0.5 rounded">
                          {svc}
                        </span>
                      ))}
                    </div>
